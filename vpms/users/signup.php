...
<head>
    ...
    <title>Downtown Parking-Signup Page</title>
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">City skies parking!! Create Your account</h2>
                    </a>
                </div>
                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="vehicleno " maxlength="10"  placeholder="Vehicle Number" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="submit" href="dashboard.php"
