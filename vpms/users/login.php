        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">City skies parking!! Sign in</h2>
                    </a>
                </div>
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                           ...
                           <input type="Email" name="emailcont" required="true" placeholder="Registered Email" required="true" class="form-control">
                        </div>
                        <div class="form-group">
